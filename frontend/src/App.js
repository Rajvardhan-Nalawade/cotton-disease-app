    ...
    return (
      <div
        ...
        className="w-full min-h-[100dvh] flex flex-col items-center px-6 py-10 bg-gradient-to-br from-green-100 to-green-50 dark:from-gray-900 dark:to-gray-800 transition-colors">
          <header className="w-full max-w-7xl flex items-center justify-between pt-6 pb-8 border-b border-black/10 dark:border-white/10">
  {/* Logo / Title */}
  <div>
    ...
    <p className="text-gray-500 dark:text-gray-400 mt-1">
      AI-powered cotton leaf disease analysis
    </p>
  </div>
  ...
  <button
    onClick={toggleDark}
    className="w-16 h-8 flex items-center bg-gray-300 dark:bg-gray-600 rounded-full p-1 transition"
  >
    <div
    ...
    />
        ...
        {/* Main card */}
        <div className="mt-8 bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-8 max-w-xl w-full text-center transition-all">
